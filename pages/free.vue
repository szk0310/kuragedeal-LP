    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-20">
      ...
      <div class="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
        ...
        <div v-if="submitted" class="flex flex-col items-center justify-center text-center py-12">
          <img src="/kurage-on-white.png" alt="クラゲディール" class="w-20 h-20 mx-auto mb-4 kurage-float" />
...
usePageSeo({
  ...
  description:
    'クラゲディールを無料で始める。Slack に追加するだけで、すぐにお使いいただけます。クレジットカードは不要です。いまならβ版を 4 ヶ月無料（10/15 まで）でご利用いただけます。',
})
