    ...
    <section class="py-16 bg-white">
      <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="text-base text-gray-700 leading-relaxed mb-8">
          ...
          <strong>「先行コミット」プログラム</strong>です。応募いただくと、β 試用が 10/15 で切れずに正式版開始まで連続利用でき、さらに正式版開始から 1 年間 50% OFF で継続できます。
        </p>
...
const faqs = [
  ...
  },
  {
    ...
    a: 'β アクセス期限が 2026 年 11 月 17 日まで自動延長されます。10 月 15 日の一斉終了を回避でき、正式版開始まで連続して利用可能です。\n※ β 試用と同じメールアドレスで応募してください。自動的に照合されます。',
  },
  {
    q: 'β 試用前 / 未経験で応募できますか？',
