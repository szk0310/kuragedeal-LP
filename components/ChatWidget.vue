  ...
  <div v-show="visible" class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        <div class="bg-kurage-700 px-4 py-3 flex items-center justify-between flex-shrink-0">
          <div class="flex items-center gap-2">
            <img src="/kurage-on-green.png" alt="" class="w-7 h-7" />
            <div>
        ...
        <div ref="messagesEl" class="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50">
          ...
          <div v-if="loading" class="flex gap-2 justify-start">
            <img src="/kurage-on-white.png" alt="" class="w-6 h-6 flex-shrink-0 mt-1" />
    ...
    <div class="flex items-center gap-3">
      ...
      <button
        ...
        @click="toggle"
      >
        <img v-if="!open" src="/kurage-on-green.png" alt="チャット" class="w-9 h-9" />
